...
const code_snippet = `await fetch("${BASE_URL}/api/v1/events", {
  method: "POST",
  body: JSON.stringify({
    category: "sale",
    fields: {
          ...
          <MaxWidthWrapper className="relative">
            <div className="-m-2 rounded-xl bg-gray-900/5 p-2 ring-1 ring-inset ring-gray-900/10 lg:-m-4 lg:rounded-2xl lg:p-4">
              <MockDiscordUI>
                <AnimatedList>
                  <DiscordMessage
                    avatar_src="/brand-asset-profile-picture.png"
                    avatar_alt="PingPanda Avatar"
                    username="PingPanda"
