    ...
    <div className="max-w-3xl flex flex-col gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card className="border-2 border-primary">
          ...
          <CardContent>
            <h2 className="text-2xl font-bold">
              {query.data?.eventsUsed || 0} of{" "}
              {query.data?.eventsLimit.toLocaleString() || 100}
            </h2>
        ...
        <Card className="border-2 border-primary">
          ...
          <CardContent>
            <h2 className="text-2xl font-bold">
              {query.data?.categoriesUsed || 0} of{" "}
              {query.data?.categoriesLimit.toLocaleString() || 10}
            </h2>
      ...
      <p className="text-sm text-muted-foreground space-x-[-20px]">
        Usage will reset{" "}
        {query.data?.resetDate && format(query.data.resetDate, "MMM d, yyyy")}{" "}
        {plan !== "PRO" ? (
          <span
